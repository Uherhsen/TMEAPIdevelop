...
Связь с EXCEL происходит через COM объкты, это не раьотает если версия экселя "Эксель Стартер"
поэтому  дальнейшая реализация обмена с экселем происходит с помощью библиотеки openpyxl
"""
