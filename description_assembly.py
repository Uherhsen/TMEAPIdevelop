...
path = "D:\\python_programming\\TMEAPIdevelop_v10\\APP\\productdata.xlsx"
...
replace_list = [["@",""]["'",""],["{",""],["}",""],[":",""],["±","+\- "],["Ø","диам. "],["®",""],["™",""], ["мама","штепсель-розетка"],["папа","штепсель-вилка"],["Монтаж THT","Монтаж в отверстия печатной платы"]]
